<template>
  <div class="container">
    <h1 class="text-center my-3">Pagina Principal</h1>
       <div class="row"> 
         <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 my-4" v-for="(item, index) in datosApi" :key="index">
           <div class="card">
              <img :src="item.image [3] ['#text']" class="card-img-top" :alt="item.index">
             <div class="card-body">
...
export default {
  name: 'PaginaPrincipal',
    data() {
      return{
         /*datosApi: [
          {name: "nombre", descripcion: "Lorems Ipsum", url: "imagen.png"},
          {name: "nombre", descripcion: "Lorems Ipsum", url: "imagen.png"},
          {name: "nombre", descripcion: "Lorems Ipsum", url: "imagen.png"},
          {name: "nombre", descripcion: "Lorems Ipsum", url: "imagen.png"},
          {name: "nombre", descripcion: "Lorems Ipsum", url: "imagen.png"},
